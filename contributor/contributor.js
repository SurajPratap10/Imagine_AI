...
async function fetchData() {
  try {
      const contributorsResponse = await fetch('https://api.github.com/repos/SurajPratap10/Imagine_AI/contributors');
      const contributorsData = await contributorsResponse.json();

      const repoResponse = await fetch('https://api.github.com/repos/SurajPratap10/Imagine_AI');
